...
public class ProviderCompartment extends BaseCompartment {
    ...
    public static class QueryBuilder<T> {
        ...
        private final com.creditease.netspy.cupboard.ProviderCompartment mCompartment;
        ...
        public QueryBuilder(Uri uri, Class<T> entityClass, com.creditease.netspy.cupboard.ProviderCompartment compartment) {
