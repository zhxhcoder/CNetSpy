...
public interface EntityConverter<T> {
     ...
     * Generally speaking do not add content values for columns that aren't returned from {@link #getColumns()} and omit columns of value {@link com.creditease.netspy.cupboard.convert.EntityConverter.ColumnType#JOIN}
     *
    ...
    public static class Column {
         ...
         * @see Index
         * @see com.creditease.netspy.cupboard.convert.IndexBuilder
         */
