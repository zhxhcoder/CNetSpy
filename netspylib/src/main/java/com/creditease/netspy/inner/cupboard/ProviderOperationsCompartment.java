...
public class ProviderOperationsCompartment extends BaseCompartment {
     ...
     * @return {@link com.creditease.netspy.inner.cupboard.ProviderOperationsCompartment} for chaining
     */
    public <T> com.creditease.netspy.inner.cupboard.ProviderOperationsCompartment put(Uri uri, T entity) {
     ...
     *
     * @return the {@link com.creditease.netspy.inner.cupboard.ProviderOperationsCompartment} for chaining.
     * @see SQLiteDatabase#yieldIfContendedSafely()
     */
    public com.creditease.netspy.inner.cupboard.ProviderOperationsCompartment yield() {
        mYieldAllowed = true;
        return this;
    }
     ...
     * @return {@link com.creditease.netspy.inner.cupboard.ProviderOperationsCompartment} for chaining. Perform other operations using the returned instance
     * to ensure yields are set after <i>operationCount</i> operations.
     */
    public com.creditease.netspy.inner.cupboard.ProviderOperationsCompartment yieldAfter(int operationCount) {
     ...
     * @return the {@link com.creditease.netspy.inner.cupboard.ProviderOperationsCompartment} for chaining
     */
    public <T> com.creditease.netspy.inner.cupboard.ProviderOperationsCompartment put(Uri uri, Class<T> entityClass, T... entities) {
     ...
     * @return this {@link com.creditease.netspy.inner.cupboard.ProviderOperationsCompartment} for chaining
     */
    public <T> com.creditease.netspy.inner.cupboard.ProviderOperationsCompartment delete(Uri uri, T entity) {
        EntityConverter<T> converter = (EntityConverter<T>) getConverter(entity.getClass());
        Long id = converter.getId(entity);
        if (id == null) {
            return this;
