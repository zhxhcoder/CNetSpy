...
public class ProviderCompartment extends BaseCompartment {
    ...
    public static class QueryBuilder<T> {
        ...
        private final com.creditease.netspy.inner.cupboard.ProviderCompartment mCompartment;
        ...
        public QueryBuilder(Uri uri, Class<T> entityClass, com.creditease.netspy.inner.cupboard.ProviderCompartment compartment) {
     ...
     * Delete an entity
     *
     * @param uri    the uri to call. The object id will be appended to this uri as per {@link ContentUris#appendId(Uri.Builder, long)}. Calling delete on an entity without an id set is a no op.
    ...
    /**
     * Delete by selection. This function is equivalent to {@link ContentResolver#delete(Uri, String, String[])}
     *
     * @param uri           the uri to call
    ...
    /**
     * Update entities using the update method of {@link ContentResolver}. Useful for 'partial' updates to an entity, or
     * multiple entities.
     * For updating 'complete' entities in bulk, use {@link #put(Uri, Class, Object[])} or {@link #put(Uri, Class, Collection)}
     *
