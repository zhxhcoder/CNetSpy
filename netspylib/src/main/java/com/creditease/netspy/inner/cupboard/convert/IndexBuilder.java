...
/**
 * Builder that can be used to build {@link Index} annotations. This is useful for custom {@link com.creditease.netspy.inner.cupboard.convert.EntityConverter}s
 * to specify their column indices in a {@link com.creditease.netspy.inner.cupboard.convert.EntityConverter.Column}. For example {@link com.creditease.netspy.inner.cupboard.convert.ReflectiveEntityConverter} will only process annotations when
 * {@link com.creditease.netspy.inner.cupboard.Cupboard#isUseAnnotations()} is <code>true</code>. By overriding {@link com.creditease.netspy.inner.cupboard.convert.ReflectiveEntityConverter#getIndexes(java.lang.reflect.Field)}
...
public class IndexBuilder {
     ...
     * @return a {@link com.creditease.netspy.inner.cupboard.convert.IndexBuilder.CompositeIndexBuilder} for chaining
     */
     ...
     */
    public com.creditease.netspy.inner.cupboard.convert.IndexBuilder unique() {
        mUnique = true;
        return this;
    }
