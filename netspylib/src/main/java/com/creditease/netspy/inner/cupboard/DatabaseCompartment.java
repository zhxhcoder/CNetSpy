...
import com.creditease.netspy.inner.cupboard.convert.EntityConverter.Column;
import com.creditease.netspy.inner.cupboard.convert.EntityConverter.ColumnType;
import com.creditease.netspy.inner.cupboard.internal.IndexStatement;
import com.creditease.netspy.inner.cupboard.internal.IndexStatement.Builder;
...
/**
 * Operate on a {@link CupboardDatabase}. A {@link com.creditease.netspy.inner.cupboard.DatabaseCompartment} is created from {@link Cupboard#withDatabase(SQLiteDatabase)}
...
public class DatabaseCompartment extends com.creditease.netspy.inner.cupboard.BaseCompartment {
    ...
    /**
     * Drop all tables for the classes registered with {@link Cupboard#register(Class)}
     */
    ...
    /**
     * Remove all indices for the classes registered with {@link Cupboard#register(Class)}, including
    ...
    public static class QueryBuilder<T> {
        ...
        private final com.creditease.netspy.inner.cupboard.DatabaseCompartment mCompartment;
        ...
        QueryBuilder(Class<T> entityClass, com.creditease.netspy.inner.cupboard.DatabaseCompartment compartment) {
