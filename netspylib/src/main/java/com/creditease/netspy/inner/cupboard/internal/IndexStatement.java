package com.creditease.netspy.inner.cupboard.internal;

import com.creditease.netspy.inner.cupboard.annotation.CompositeIndex;
...
//		create *unique* index *if not exists* indexName on tableName ('col1' asc, 'col2' desc, 'col3' asc)
    ...
    public static class Builder {
        ...
        private void addCompositeIndex(String columnName, Map<String, Set<IndexColumnMetadata>> collectionToAdd, boolean ascending, int order, String indexName) {
            ...
            if (set == null) {
                set = new HashSet<com.creditease.netspy.inner.cupboard.internal.IndexStatement.Builder.IndexColumnMetadata>();
        ...
        public List<com.creditease.netspy.inner.cupboard.internal.IndexStatement> build() {
            List<com.creditease.netspy.inner.cupboard.internal.IndexStatement> indexStatements = new ArrayList<com.creditease.netspy.inner.cupboard.internal.IndexStatement>();
        ...
        public Map<String, com.creditease.netspy.inner.cupboard.internal.IndexStatement> buildAsMap() {
            Map<String, com.creditease.netspy.inner.cupboard.internal.IndexStatement> map = new HashMap<String, com.creditease.netspy.inner.cupboard.internal.IndexStatement>();
            for (com.creditease.netspy.inner.cupboard.internal.IndexStatement is : build()) {
                map.put(is.mIndexName, is);
            }
            return map;
        }

        public void addStatementToList(String indexName, boolean unique, List<com.creditease.netspy.inner.cupboard.internal.IndexStatement> indexStatements, Set<IndexColumnMetadata> metadatas) {
            ...
            indexStatements.add(new com.creditease.netspy.inner.cupboard.internal.IndexStatement(unique, columnNames, ascendingColumns, indexName));
        }
